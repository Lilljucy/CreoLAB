  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-[background-color,backdrop-filter,border-color] duration-300 ${
        scrolled || open ? "glass-header" : "border-b border-transparent bg-transparent"
      }`}
    >
      <div className="header-bottom-fade" aria-hidden />
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-5 md:px-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href={`/${locale}/kontakt`} className="btn-pill hidden px-5 py-2.5 text-sm md:inline-flex">
            {t.nav.cta}
          </Link>
          <button
            type="button"
