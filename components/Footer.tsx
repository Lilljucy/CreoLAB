...
export default function Footer({ locale }: { locale: Locale }) {
  ...
  return (
    <footer id="contact" className="relative overflow-hidden bg-[var(--surface)] px-6 pt-8 pb-20">
      <div className="relative z-10 mx-auto max-w-5xl">
        ...
        <div className="mb-16 flex justify-center gap-3">
          <a
            ...
            className="flex h-11 w-11 items-center justify-center rounded-full border border-[var(--border)] transition-colors hover:bg-[var(--surface-2)]"
          >
